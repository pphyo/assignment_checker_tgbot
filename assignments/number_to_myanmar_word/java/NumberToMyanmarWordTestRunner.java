public class NumberToMyanmarWordTestRunner {
    ...
    private static String normalizePrefix(String word) {
        return word.replace("တစ်", "တ");
    }

    public static void main(String[] args) {
        NumberToMyanmarWord converter = new NumberToMyanmarWord();

        int[] inputs = { 0, 5, 10, 11, 25, 100, 101, 110, 1000, 1001, 1234, 10000, 10101, 11000, 110101, 123456,
                1000000 };
        // Expected outputs use simplified grammar AND the "တ" prefix for consistency in
        // the test itself
        String[] expectedOutputs = {
                "သုညကျပ်", "ငါးကျပ်", "တဆယ်ကျပ်", "တဆယ်တစ်ကျပ်", "နှစ်ဆယ်ငါးကျပ်", "တရာကျပ်", "တရာတစ်ကျပ်",
                "တရာတဆယ်ကျပ်",
                "တထောင်ကျပ်", "တထောင်တစ်ကျပ်", "တထောင်နှစ်ရာသုံးဆယ်လေးကျပ်",
                "တသောင်းကျပ်", "တသောင်းတရာတကျပ်", "တသောင်းတထောင်ကျပ်",
                "တသိန်းတသောင်းတရာတကျပ်", "တသိန်းနှစ်သောင်းသုံးထောင်လေးရာငါးဆယ်ခြောက်ကျပ်",
                "တသန်းကျပ်"
        };
        ...
        for (int i = 0; i < inputs.length; i++) {
            ...
            try {
                ...
                if (normalizedExpected.equals(normalizedActual)) {
                    ...
                    report.append(" -> ❌ FAIL (Normalized: Expected '").append(normalizedExpected).append("', Got '")
                            .append(normalizedActual).append("')\n\n");
                }
            } catch (Exception e) {
